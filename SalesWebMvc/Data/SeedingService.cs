...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            // Any testa se existe algum registro na tabela
            if(_context.Department.Any() ||
                _context.Seller.Any() ||
                _context.SalesRecord.Any())
            {
                return;
                    ; // O banco de dados já foi populado (seeded)
            }

            // adicionar os objetos que irão popular o banco de dados
            ...
            // adicionar os objetos no banco de dados utilizando o EntityFrameWork
